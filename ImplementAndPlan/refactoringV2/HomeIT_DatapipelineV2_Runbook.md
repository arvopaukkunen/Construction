...
Before these 2 stages, IoT sensor and appliance integration layer is extracting data and get orchestrated by NodeRed. Nodered is in role, that does not do any data alterations - simply integrates and delivered it to device by device - to S3 compatible onprem storage bucket named raw.
